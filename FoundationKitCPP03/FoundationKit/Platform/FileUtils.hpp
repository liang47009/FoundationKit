...
****************************************************************************/
#ifndef FOUNDATIONKIT_FILEUTILS_HPP
#define FOUNDATIONKIT_FILEUTILS_HPP
...
public:
   ...
   /**
    * Get all line data from a file
    * @param    fullPath A file path.
    */
...
#endif // FOUNDATIONKIT_FILEUTILS_HPP
