...
namespace MimeTypes
{
    ...
    inline std::string GetMimeTypeWithExtension(std::string extension) {
    ...
    inline std::string GetMimeType(std::string fileName)
    {
        size_t dot = fileName.find_last_of('.');
        std::string extension = fileName.substr(dot + 1);
        return GetMimeTypeWithExtension(extension);
    }
