...
****************************************************************************/
#ifndef FOUNDATIONKIT_NETWORKING_DETAIL_CONFIG_HPP
#define FOUNDATIONKIT_NETWORKING_DETAIL_CONFIG_HPP

/** 
 By default, Networking is a header-only library.
 However, some developers may prefer to build Networking using separately compiled source code.
 To do this, add #include <Networking/detail/src.hpp> to one(and only one) source file in a program,
 then build the program with NETWORK_SEPARATE_COMPILATION defined in the project / compiler settings.
 Alternatively, NETWORK_DYNAMIC_LINK may be defined to build a separately - compiled Networking as part of a shared library.

 Defined these macors in the project / compiler settings if need.
 |--------------------------------------------|--------------------------------------------------------------|
 | Macro                                      | Description                                                  |
 |--------------------------------------------|--------------------------------------------------------------|
 | NETWORK_SEPARATE_COMPILATION               | Build Networking using separately compiled source code.      |
 |--------------------------------------------|--------------------------------------------------------------|
 | NETWORK_DYNAMIC_LINK                       | Build Networking as part of a shared library.                |
 |--------------------------------------------|--------------------------------------------------------------|
...
#endif // END OF FOUNDATIONKIT_NETWORKING_DETAIL_CONFIG_HPP
