...
namespace MimeTypes
{
    ...
    //data from mono project[mcs\class\System.Web\System.Web\MimeTypes.cs]
    static mapping memiTypes[] = 
    {
        {"323", "text/h323"},
        {"3dmf", "x-world/x-3dmf"},
        {"3dm", "x-world/x-3dmf"},
        ...
        {"mp3", "audio/mpeg"},
        {"mp4", "video/mp4"},
        //{"mp4a", "audio/mp4"},  // A common but unofficial alternative to m4a
        {"mpa", "audio/mpeg"},
    ...
    std::string GetMimeType(std::string fileName)
    {
        ...
        if (dot != std::string::npos && fileName.length()> dot+1)
        {
            for (mapping* m = memiTypes; m->extension; ++m)
            {
