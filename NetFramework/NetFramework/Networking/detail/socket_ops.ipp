...
****************************************************************************/
#ifndef NETFRAMEWORK_SOCKET_OPS_IPP
#define NETFRAMEWORK_SOCKET_OPS_IPP
    ...
    addrinfo_type** result, std::error_code& ec)
{
  ...
  return ec = translate_addrinfo_error(error);
#endif //#if PLATFORM_WINDOWS || defined(__CYGWIN__)
}
...
#endif // END OF NETFRAMEWORK_SOCKET_OPS_IPP
