...
#include "tinythread.h"
  ...
  #include <unistd.h>
  #include <map>
#elif defined(_TTHREAD_WIN32_) || defined(_TTHREAD_WIN_PHONE_)
  #include <process.h>
#endif
...
#if defined(_TTHREAD_WIN32_) || defined(_TTHREAD_WIN_PHONE_)
...
#else
  mEvents[_CONDITION_EVENT_ONE] = CreateEventEx(NULL, NULL, 0, EVENT_ALL_ACCESS);
  mEvents[_CONDITION_EVENT_ALL] = CreateEventEx(NULL, NULL, CREATE_EVENT_MANUAL_RESET, EVENT_ALL_ACCESS);
#endif
#ifdef _TTHREAD_WIN_PHONE_
