...
*
* Original file from Facebook : https://github.com/facebook/folly
*
 ...
 * Example:
 *
 *    int x = NS_NAME::applyTuple(std::plus<int>(), std::make_tuple(12, 12));
 *    ASSERT(x == 24);
 *    A a;
 *    int x = NS_NAME::applyTuple(&A::fun, std::make_tuple(&a,12, 12));
 */
...
typename detail::ReturnValue< typename std::decay<Callable>::type,
