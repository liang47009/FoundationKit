...
****************************************************************************/
#ifndef LOSEMYMIND_HTTPRESPONSE_HPP
#define LOSEMYMIND_HTTPRESPONSE_HPP
...
protected:
    // properties
    HTTPRequest::Pointer _pHTTPpRequest;          /// the corresponding HttpRequest pointer who leads to this response 
...
#endif // LOSEMYMIND_HTTPRESPONSE_HPP
